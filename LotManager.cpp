...
{
    lot_list[0] = new Lot(0, 180, -30, 30, 140, 0.4, 0.01, 0.03);
    lot_list[1] = new Lot(180, 220, -30, 30, 110, 1.5, 0.03, 0.06);
    lot_list[2] = new Lot(150, 200, -50, -20, 110, 1.0, 0.01, 0.05);
    lot_list[3] = new Lot(0, 30, -100, -75, 100, 1.5, 0.03, 0.06);
    lot_list[4] = new Lot(50, 100, -200, -75, 100, 1.4, 0.03, 0.07);
    lot_list[5] = new Lot(0, 250, -250, -200, 140, 0.4, 0.01, 0.03);
    lot_list[6] = new Lot(0, 250, -400, -360, 60, 0.86, 0.00, 0.04);
    lot_list[7] = new Lot(150, 250, -700, 0, 20, 0.4, 0.00, 0.03);
}
