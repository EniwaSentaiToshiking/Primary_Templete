...
{
    lot_list[0] = new Lot(0, 180, -30, 30, 130, 0.4, 0.01, 0.03);
    ...
    lot_list[5] = new Lot(0, 250, -250, -200, 130, 0.4, 0.01, 0.03);
...
{
    lot_list[0] = new Lot(0, 180, -30, 30, 130, 0.4, 0.01, 0.03);
    lot_list[1] = new Lot(180, 220, -30, 30, 110, 1.9, 0.02, 0.14);
    lot_list[2] = new Lot(150, 200, -50, -30, 110, 0.9, 0.01, 0.04);
    lot_list[3] = new Lot(0, 30, -100, -75, 100, 1.4, 0.01, 0.07);
    lot_list[4] = new Lot(50, 100, -200, -75, 100, 1.8, 0.01, 0.1);
    lot_list[5] = new Lot(0, 250, -250, -200, 130, 0.4, 0.01, 0.03);
